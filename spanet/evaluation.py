...
def evaluate_on_test_dataset(
    ...
    for batch in dataloader:
        ...
        dummy_index = torch.arange(assignment_indices[0].shape[0]).unsqueeze(-1).repeat(1, assignment_indices[0].shape[-1]).T
        for assignment_probability, assignment, symmetries in zip(
            ...
            assignment_probability = assignment_probability.__getitem__((dummy_index, *assignment.transpose(1, 2, 0)))
